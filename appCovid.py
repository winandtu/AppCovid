...
def AppCoron():
    ...
    #Se crean las matrices que guardaran los datos 
    MediaProbabilidad=[]
    AltaProbabilidad=[]
    BajaProbabilidad=[]
    DatosRigor=[]
  ...
  #Funcion donde se registraran los datos generales
    ...
    def Preguntas_Diagnostico():
        ...
        Fila=[Fiebre,Ahogo,Olfato_Gusto,Dolor_Pecho,MalestarGarganta,Tos,Casancio]
        return Fila

    #Ingreso de Datos y Creacion de los Arreglos
    #Se guardaran los datos de cada paciente en cada arreglo
    ...
    #Se categorizan los nombres segun el Rango De Probabilidad
    print("------------------NOMBRES DE PACIENTES  POR RANGO DE PROBABILIDAD-------------------------")
    print("\n.........................................................................................")
    print("Los pacientes que tiene una probabilidad alta de  tener Covid-19 son:")
    
    for i in range(0,len(AltaProbabilidad),1):
        
        print(i+1,": ",AltaProbabilidad[i][0])
    ...
    while Graficas=="si":    
        ...
        if(p>=1 and p<=3):
            ...
            Legendas["Alta probabilidad","Media probabilidad","Baja probabilidad"]
            sizes=[CantidadDePersonasAltaProbabilidad,CantidadDePersonasMediaProbabilidad,CantidadDePersonasBajaProbabilidad]
            fig1,ax1=plt.subplots()
            _, _, texto=ax1.pie(sizes,labels=Legendas,autopct='%1.1f%%',startangle=90)
            for tex in texto:
                tex.set_color('white')
            ax1.axis('equal')
            plt.title("Proabilidades totales")
            plt.savefig("Todas las probabilidades.png")      
        else:
            if(p==4):
                p=0
            elif(p==5):
            ...
            Legendas=["De 0 a 15",">15, <=40",">40, <=60","Más de 60"]
            ...
            plt.savefig(nme2[p])
        print("")
        #El usuario tiene la opcion de escoger las distintas graficas o si desea descargar todas
